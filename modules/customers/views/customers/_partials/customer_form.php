...
<form method="post" accept-charset="utf-8" id="customer">
    ...
    <div class="span3">
        ...
        <div class="control-group">
            <div class="controls controls-row">
                <?php echo twitter_html_input_text('postalcode_text', xss_clean($postalcode_text), null, array(), array(), array('tabindex' => 9, 'autocomplete' => 'off', 'data-provide' => 'typeahead', 'data-link' => \Fuel\Core\Uri::create('/customers/postalcodes/rest/search'))) ?>
        ...
        <div class="control-group">
            <div class="controls controls-row">
                <?php echo twitter_html_select('country_id', $countries, xss_clean($country_id), extend_locale('country.label'), array(), array(), false, array('tabindex' => 11)) ?>
            </div>
        </div>
    ...
    <div class="span3">
        ...
        <div class="control-group">
            <div class="controls controls-row">
                <?php echo twitter_html_input_text('city_text', xss_clean($city_text), null, array(), array(), array('class' => '', 'tabindex' => 10)) ?>
            </div>
        </div>
