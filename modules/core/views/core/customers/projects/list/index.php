    ...
    <?php if (!empty($crud_objects['customer_project']['data'])): ?>
        <table class="table table-striped table-condensed table-bordered">
            ...
            <?php foreach ($crud_objects['customer_project']['data'] as $customer_project): ?>
                <tr>
                    <td><?php echo html_anchor(named_route('core_customers_projects_show', array('id' => $customer_project->id, 'customer_id' => $customer_project->customer_id)), xss_clean($customer_project->name)) ?></td>
                    ...
                    <td>
                        ...
                        array('attr' => array(), 'value' => html_anchor(named_route('core_customers_projects_show', array('id' => $customer_project->id, 'customer_id' => $customer_project->customer_id)), __(extend_locale('actions.show.label')))),
                        array('attr' => array(), 'value' => html_anchor(named_route('core_customers_projects_edit', array('id' => $customer_project->id, 'customer_id' => $customer_project->customer_id)), __(extend_locale('actions.edit.label')))),
                        array('attr' => array(), 'value' => html_anchor(named_route('core_customers_projects_delete', array('id' => $customer_project->id, 'customer_id' => $customer_project->customer_id)), __(extend_locale('actions.delete.label')))),
