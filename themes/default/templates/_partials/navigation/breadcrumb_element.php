...
<li<?php echo ($li_class != '') ? ' class="' . $li_class . '"' : '' ?>>
    <?php if ($last == false): echo html_anchor($element->get_route(), __('breadcrumb.' . $element->name . '.anchor.label'), $anchor_attributes) ?> <?php echo html_tag('span', array('class' => 'divider'), '/') ?>
